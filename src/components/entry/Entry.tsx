...
export function Entry(props: IEntryProps) {
    ...
    function onCheck(e : any) {
        e.preventDefault();
        let to : string = props.entry.done ? "todos" : "done";
        let from : string = to === "todos" ? "done" : "todos";
    ...
    function onDelete(e:any) {
        e.preventDefault();
        let collection : string = props.entry.done ? "done" : "todos";
    ...
    return <>
        ...
        <a onClick={(e) => e.preventDefault() } href="#" className="entry list-group-item list-group-item-action flex-column align-items-start">
